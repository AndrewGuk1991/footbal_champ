...
export const TEAMS_DATA: Record<string, TeamData> = {
    'ajax': {
        ...
        midfielders: [
            ...
            { name: 'Андрей', surname: 'Гук', number: 8, games: 14, yellowCards: 1, photo: player_8},
        ...
        forwards: [
            ...
            { name: 'Даниил', surname: 'Лемешевский', number: 10, goals: 11, games: 14, yellowCards: 1 },
            { name: 'Виктор', surname: 'Ибраев', number: 13, games: 14 },
            { name: 'Дмитрий', surname: 'Киселев', number: 14, goals: 4, games: 14, yellowCards: 1 },
        ]
    },
    'pinskdrew': {
        title: 'Пинскдрев',
        ...
        forwards: [
            ...
            { name: 'Артур', surname: 'Демчишин', number: 17, games: 14, goals: 1 },
    ...
    'pikant': {
        ...
        defenders: [
            ...
            { name: '...', surname: 'Гузаревич', number: 30, games: 7, goals: 1 },
        ],
        midfielders: [
            { name: '...', surname: 'Павелко', number: 8, goals: 10, games: 14 },
            { name: 'Константин', surname: 'Кончаленко', number: 16, goals: 4, games: 14 },
            { name: 'Михаил', surname: 'Головко', number: 20, games: 14, goals: 2 },
            { name: 'Даниил', surname: 'Шпаковский', number: 11, games: 14, goals: 1 },
            { name: 'Максим', surname: 'Наварич', number: 21, games: 14, goals: 1 },
        ],
        forwards: [
            { name: 'Дмитрий', surname: 'Курадовец', number: 17, games: 14, yellowCards: 1 },
            ...
            { name: 'Александр', surname: 'Дубойский', number: 31, games: 7, yellowCards: 1 },
        ]
    },
    'dinamo': {
        title: 'Динамо',
    ...
    'odyssey': {
        ...
        defenders: [
            ...
            { name: 'Иван', surname: 'Виннель', number: 32, games: 7 },
        ],
        midfielders: [
    ...
    'vityaz': {
        ...
        defenders: [
            ...
            { name: '...', surname: 'Пасовец', number: 31, games: 7, goals: 1 },
        ],
        midfielders: [
        ...
        forwards: [
            ...
            { name: '...', surname: 'Гудвилович', number: 30, games: 7, goals: 1 },
        ]
    },
    'arsenal': {
        title: 'Арсенал',
        ...
        forwards: [
            { name: 'Виталий', surname: 'Андрукевич', number: 10, goals: 1, yellowCards: 1 },
